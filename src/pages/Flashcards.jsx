...
export default function FlashcardsStudy() {
  ...
  const addCard = async () => {
    ...
    try {
      ...
      setCards([...cards, res.data.card]); // ✅ fix: add new card properly
  ...
  const handleFlip = (id) => {
    ...
    setStudied((prev) => {
      const updated = new Set(prev);
      updated.add(id);
      if (updated.size === cards.length && cards.length > 0) {
        launchConfetti();
      }
      return updated;
    });
            ...
            <CardContent>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  ...
                  >
                    {saving ? "Saving..." : "Create Sticky Note"}
                  </Button>
                </Grid>
              </Grid>
            </CardContent>
          ...
          >
            ...
            <Box sx={{ flexGrow: 1, mx: 2 }}>
              <LinearProgress
                variant="determinate"
                value={
                  cards.length > 0 ? (studiedCount / cards.length) * 100 : 0
                }
